...
INSERT INTO `mission_config` (`name`, `config_type`, `config_value`) VALUES
...
INSERT INTO `conversations` (`conversation_id`, `name`, `parent_conversation_id`, `date_created`, `last_message_mcc`, `last_message_hab`) VALUES
